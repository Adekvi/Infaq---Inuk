<x-utama.layout.main title="Dashboard Admin Kabupaten">
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    @if (session('admin_kabupaten'))
                                        <div class="text-success">
                                            <i class="fa-solid fa-temperature-three-quarters"></i> Sedang Aktif
                                        </div>
                                    @endif
                                    <strong>
                                        <strong>Donasi {{ number_format($kecamatan_mengirim, 0, ',', '.') }} dari
                                            {{ number_format($total_kecamatan, 0, ',', '.') }} Kecamatan
                                            ({{ number_format($persentase_kecamatan_mengirim, 2) }}%)</strong>
                                    </strong>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <h6 class="card-header m-0 me-2 pb-3">
                                <strong>
                                    ...
                                    Rekap Donasi per Kecamatan
                                </strong>
                                <hr>
                            </h6>
                            <div class="card-body">
                                @forelse ($rekap_per_kecamatan as $data)
                                    <div class="mb-2">
                                        <strong>Kecamatan
                                            {{ $data->nama_kecamatan ?? ($data->id_kecamatan ?? '-') }}</strong>
                                        <div class="d-flex flex-column flex-md-row justify-content-between">
                                            ...
                                            <div class="text-md-end">
                                                <span>
                                                    <strong>Rp
                                                        {{ number_format($data->total_donasi, 0, ',', '.') }}</strong>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
