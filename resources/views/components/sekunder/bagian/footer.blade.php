<div class="container-fluid footer py-5 wow fadeIn" data-wow-delay="0.2s">
    <div class="container py-5 border-start-0 border-end-0"
        style="border: 1px solid; border-color: rgba(255, 255, 255, 0.08);">
        <div class="row g-5">
            <div class="col-md-6 col-lg-6 col-xl-4">
                <div class="footer-item">
                    <a href="#" class="p-0 text-decoration-none">
                        <h1 class="text-primary"><i class="fa-solid fa-feather me-3"></i>INUK</h1>
                    </a>
                    <p class="mb-4">INUK (Infaq NU Kudus) adalah program pengelolaan infaq yang amanah dan transparan,
                        membantu umat untuk kesejahteraan bersama.</p>
                    <div class="d-flex">
            ...
            <div class="col-md-6 col-lg-6 col-xl-2">
                <div class="footer-item">
                    ...
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Donasi</a>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <p class="text-white mb-0">Jl. KH. Wahid Hasyim No. 45, Kudus, Jawa Tengah</p>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <i class="fas fa-envelope text-primary me-3"></i>
                        <p class="text-white mb-0">info@inuk-nukudus.org</p>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <i class="fas fa-phone-alt text-primary me-3"></i>
                        <p class="text-white mb-0">+62 857 1234 5678</p>
                    </div>
            ...
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-body">
                    <a href="#" class="border-bottom text-white">
                        <i class="fas fa-copyright text-light me-2"></i>INUK : Infaq NU Kudus
