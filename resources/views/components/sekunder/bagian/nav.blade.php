                        ...
                        <div class="col-xl-7 animated fadeInLeft">
                            <div class="text-sm-center text-md-end">
                                ...
                                <h1 class="display-4 text-uppercase text-white mb-4">Salurkan Infaq untuk Umat &
                                    Kesejahteraan</h1>
                                <p class="mb-5 fs-6">Bersama LAZISNU, setiap infaq Anda menjadi harapan bagi yang
                                    membutuhkan. INUK hadir untuk menjembatani kebaikan dengan amanah dan transparansi.
                                </p>
                    ...
                    <div class="row g-5">
                        <div class="col-12 animated fadeInUp">
                            <div class="text-center">
                                ...
                                <p class="mb-5 fs-5">Melalui program INUK, LAZISNU hadir menjadi solusi penyaluran infaq
                                    yang tepat guna, penuh keberkahan, dan menyentuh langsung masyarakat yang
                                    membutuhkan.</p>
                                <div class="d-flex justify-content-center flex-shrink-0 mb-4">
                                    <a class="btn btn-light rounded-pill py-3 px-4 px-md-5 me-2" href="#"><i
                                            class="fas fa-play-circle me-2"></i> Tonton Video</a>
                                    <a class="btn btn-primary rounded-pill py-3 px-4 px-md-5 ms-2" href="#">Donasi
                                        Sekarang</a>
                                </div>
