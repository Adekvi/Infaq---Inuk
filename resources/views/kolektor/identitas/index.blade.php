<x-utama.layout.main title="Kartu Identitas Petugas">
                ...
                <div class="col-md-9">
                    <div class="card mb-6 shadow-sm"
                        ...
                        <div class="card-header bg-secondary text-center" style="border-radius: 12px 12px 0 0;">
                            <h5 class="mb-0 text-white">Kartu Identitas Petugas</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 text-center mt-2">
                                    ...
                                    <img src="{{ $fotoPath }}" alt="Foto Petugas" class="img-fluid rounded"
