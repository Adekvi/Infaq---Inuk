            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="pasien-bpjs">
                    <div class="card-title">
                        <h5><strong>Penerimaan Infaq</strong></h5>
                    </div>
                                ...
                                @if ($terima->isEmpty())
                                    <div class="col-12">
                                        <div class="alert alert-warning text-center">
                                            <i class="fa-solid fa-circle-xmark"></i> Tidak ada data
                                        </div>
                                    </div>
                                @else
                            ...
                            <div class="col-md-3 mt-2">
                                <div class="card bg-light">
                                    <div class="card-body text-center text-dark">
                                        <i class="fa-solid fa-sack-dollar fa-2x me-2"></i>
                                        Total: <strong>{{ Rupiah($terima->sum('nominal')) }}</strong>
                                    </div>
                                </div>
                            </div>
