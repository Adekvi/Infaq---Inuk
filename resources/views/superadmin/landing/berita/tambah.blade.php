        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="card-title">
                    <h5 style="margin-bottom: 20px"><strong>Tambah Berita & Blog</strong></h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('superadmin/landing/berita/tambah') }}" method="POST"
                            ...
                            <div class="row p-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="ringkasan" id="ringkasan" class="form-control mt-2 mb-2" cols="5" rows="5"
                                        placeholder="Dapatkan informasi terbaru mengenai kegiatan sosial, edukasi filantropi, serta kisah nyata dari para penerima manfaat infaq Anda. Bersama INUK, setiap infaq adalah jalan keberkahan."></textarea>
                                </div>
                                <div class="col-md-6">
