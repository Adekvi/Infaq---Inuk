        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="card-title">
                    <h5 style="margin-bottom: 20px"><strong>Edit Layanan Kami</strong></h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('superadmin/landing/layanan-kami/edit/' . $layanan->id) }}" method="POST"
                            ...
                            <div class="row p-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="tag" id="tag" class="form-control mt-2 mb-2"
                                        placeholder="Layanan Kami" value="{{ $layanan->tag ?? '-' }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" class="form-control mt-2 mb-2" cols="5" rows="5"
                                        placeholder="Melalui INUK dari LAZISNU, kami menghadirkan berbagai layanan sosial dan pemberdayaan untuk menjangkau masyarakat yang membutuhkan secara langsung, transparan, dan penuh keberkahan.">{{ $layanan->deskripsi ?? '-' }}</textarea>
                                </div>
                                <h5>
                                    <strong>
                                        <li>Konten</li>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="layanan" id="layanan" class="form-control mt-2 mb-2"
                                        placeholder="Infaq yang Amanah" value="{{ $layanan->layanan ?? '-' }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div id="preview-foto" class="mt-2">
                                        @if ($layanan->foto)
                                            <img src="{{ asset('storage/' . $tentang->foto) }}" alt="Icon 1"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="ringkasan" id="ringkasan" class="form-control mt-2 mb-2" cols="5" rows="5"
                                        placeholder="Setiap donasi dikelola secara profesional dan disalurkan tepat sasaran.">{{ $layanan->ringkasan ?? '-' }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control mt-2 mb-2">
                                            ...
                                            <option value="Aktif" {{ $layanan->status == 'Aktif' ? 'selected' : '' }}>
                                                Aktif</option>
                                            <option value="Nonaktif"
                                                {{ $layanan->status == 'Nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
