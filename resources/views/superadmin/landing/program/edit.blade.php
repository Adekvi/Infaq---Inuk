        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="card-title">
                    <h5 style="margin-bottom: 20px"><strong>Edit Program Kami</strong></h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('superadmin/landing/program-kami/edit/' . $program->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="tag" id="tag" class="form-control mt-2 mb-2"
                                        placeholder="Program Kami" value="{{ $program->tag ?? '-' }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="program1" id="program1" class="form-control mt-2 mb-2"
                                        placeholder="INUK" value="{{ $program->program1 ?? '-' }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div id="preview-foto1" class="mt-2">
                                        @if ($program->foto1)
                                            <img src="{{ asset('storage/' . $program->foto1) }}" alt="Icon 1"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="ringkasan1" id="ringkasan1" class="form-control mt-2 mb-2" cols="5" rows="5"
                                        placeholder="Program donasi infaq yang dikelola oleh NU Kudus untuk mendukung pendidikan, kesehatan, dan kegiatan sosial keumatan.">{{ $program->ringkasan1 ?? '-' }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="">Program 2</label>
                                    <input type="text" name="program2" id="program2" class="form-control mt-2 mb-2"
                                        placeholder="Mobil Layanan Ummat (MLU)" value="{{ $program->program2 ?? '-' }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div id="preview-foto2" class="mt-2">
                                        @if ($program->foto2)
                                            <img src="{{ asset('storage/' . $program->foto2) }}" alt="Icon 1"
                                                style="max-height: 200px;" class="mb-2">
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <textarea name="ringkasan2" id="ringkasan2" class="form-control mt-2 mb-2" cols="5" rows="5"
                                        placeholder="Layanan mobil gratis untuk masyarakat yang membutuhkan, mulai dari kesehatan, edukasi, hingga bantuan darurat langsung ke lokasi.">{{ $program->ringkasan2 ?? '-' }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="">Program 3</label>
                                    <input type="text" name="program3" id="program3"
                                        class="form-control mt-2 mb-2" placeholder="Qurban"
                                        value="{{ $program->program3 ?? '-' }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div id="preview-foto3" class="mt-2">
                                        @if ($program->foto3)
                                            <img src="{{ asset('storage/' . $program->foto3) }}" alt="Icon 1"
                                                style="max-height: 200px;" class="mb-2">
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <textarea name="ringkasan3" id="ringkasan3" class="form-control mt-2 mb-2" cols="5" rows="5"
                                        placeholder="Program Qurban terpercaya yang amanah dan profesional, menyebarkan kebahagiaan hingga pelosok desa yang membutuhkan.">{{ $program->ringkasan3 ?? '-' }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="">Program 4</label>
                                    <input type="text" name="program4" id="program4"
                                        class="form-control mt-2 mb-2" placeholder="Santunan"
                                        value="{{ $program->program4 ?? '-' }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div id="preview-foto4" class="mt-2">
                                        @if ($program->foto4)
                                            <img src="{{ asset('storage/' . $program->foto4) }}" alt="Icon 1"
                                                style="max-height: 200px;" class="mb-2">
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <textarea name="ringkasan4" id="ringkasan4" class="form-control mt-2 mb-2" cols="5" rows="5"
                                        placeholder="Santunan untuk anak yatim, kaum dhuafa, dan korban musibah sebagai bentuk kepedulian sosial dan solidaritas ummat.">{{ $program->ringkasan4 ?? '-' }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control mt-2 mb-2">
                                            ...
                                            <option value="Nonaktif"
                                                {{ $program->status == 'Nonaktif' ? 'selected' : '' }}>Nonaktif
                                            </option>
                                        </select>
                                    </div>
                                </div>
