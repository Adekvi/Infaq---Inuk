<x-utama.layout.main title="Superadmin | Program Kami">
            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="pasien-bpjs">
                    <div class="card-title">
                        <h5 style="margin-bottom: 20px"><strong>Program Kami</strong></h5>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="mb-1" style="display: flex; justify-content: space-between">
                                <h5>Tabel Data</h5>
                                <a href="{{ url('superadmin/landing/program-kami/tambah-data') }}"
                        ...
                        <div class="card-body">
                            <div
                                ...
                                <form method="GET" action="{{ route('superadmin.landing.program') }}"
                                    ...
                                    <div class="d-flex gap-2 align-items-end">
                                        <div>
                                            <a href="{{ route('superadmin.landing.program') }}"
                            ...
                            <div class="row">
                                ...
                                @else
                                                ...
                                                <div class="card-body">
                                                    <h6 class="card-title mb-2">
                                                        <div class="d-flex justify-content-between">
                                                            #{{ $program->firstItem() + $index }}
                                                            {{-- <span>{{ $item->username }}</span> --}}
                                                            <form method="POST"
                                                                action="{{ url('superadmin/landing/program-status') }}">
                                                                @csrf
                                                    ...
                                                    <div class="d-flex justify-content-start gap-2 mt-3">
                                                        <div
                                                            ...
                                                            <a href="{{ url('superadmin/landing/program-kami/edit-data/' . $item->id) }}"
                                    ...
                                    <div class="col-12 mt-3 d-flex justify-content-end">
                                        {{ $program->appends(['entries' => $entries])->links() }}
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    @include('superadmin.landing.program.modal.detail')
    @include('superadmin.landing.program.hapus')
