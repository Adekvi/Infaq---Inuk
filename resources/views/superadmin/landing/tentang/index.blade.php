<x-utama.layout.main title="Superadmin | Tentang Kami">
            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="pasien-bpjs">
                    <div class="card-title">
                        <h5 style="margin-bottom: 20px"><strong>Tentang Kami</strong></h5>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="mb-1" style="display: flex; justify-content: space-between">
                                <h5>Tabel Data</h5>
                                <a href="{{ url('superadmin/landing/tentang-kami/tambah-data') }}"
                        ...
                        <div class="card-body">
                            <div
                                ...
                                <form method="GET" action="{{ route('superadmin.landing.tentang') }}"
                                    ...
                                    <div class="d-flex gap-2 align-items-end">
                                        <div>
                                            <a href="{{ route('superadmin.landing.tentang') }}"
                            ...
                            <div class="row">
                                ...
                                @else
                                                ...
                                                <div class="card-body">
                                                    <h6 class="card-title mb-2">
                                                        <div class="d-flex justify-content-between">
                                                            #{{ $tentang->firstItem() + $index }}
                                                            {{-- <span>{{ $item->username }}</span> --}}
                                                            <form method="POST"
                                                                action="{{ url('superadmin/landing/tentang-status') }}">
                                                                @csrf
                                                    ...
                                                    <div class="mb-1 d-flex">
                                                        <div style="width: 53px;"><strong>Judul</strong>
                                                        </div>
                                                    ...
                                                    <div class="mb-1 d-flex">
                                                        <div style="width: 100px;"><strong>Sub Judul</strong>
                                                        </div>
                                                        <span class="me-1">:</span>
                                                        <div>
                                                            {{ $item->subjudul ?? '-' }}
                                                    ...
                                                    <div class="d-flex justify-content-start gap-2 mt-3">
                                                        <div
                                                            ...
                                                            <a href="{{ url('superadmin/landing/tentang-kami/edit-data/' . $item->id) }}"
                                    ...
                                    <div class="col-12 mt-3 d-flex justify-content-end">
                                        {{ $tentang->appends(['entries' => $entries])->links() }}
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    @include('superadmin.landing.tentang.modal.detail')
    @include('superadmin.landing.tentang.hapus')
