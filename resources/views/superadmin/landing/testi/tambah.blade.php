        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="card-title">
                    <h5 style="margin-bottom: 20px"><strong>Tambah Testimoni</strong></h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('superadmin/landing/testi/tambah') }}" method="POST"
                            ...
                            <div class="row p-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="ringkasan" id="ringkasan" class="form-control mt-2 mb-2" cols="5" rows="5"
                                        placeholder="Berikut adalah kesan dan pesan dari para donatur serta penerima manfaat program INUK. Mereka merasakan langsung dampak nyata dari infaq yang dikelola oleh LAZISNU."></textarea>
                                </div>
                                <h5>
                                    <strong>
                                        <li>Konten</li>
