            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card-title">
                    ...
                    <div class="mb-1" style="display: flex; justify-content: start">
                        <code>Edit Data Template Pesan</code>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('superadmin/master-data/pesan/edit/' . $pesan->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="namapesan" id="namapesan"
                                            value="{{ $pesan->value }}" placeholder="Pesan"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="template" id="template" class="form-control mt-2 mb-2" cols="10" rows="5">{{ $template }}</textarea>
                                    </div>
                                </div>
                            </div>
