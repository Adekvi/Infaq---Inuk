            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card-title">
                    ...
                    <div class="mb-1" style="display: flex; justify-content: start">
                        <code>Edit Data Kelurahan</code>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('superadmin/master-data/wilayah-kelurahan/edit/' . $kelurahan->id) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_kelurahan" id="nama_kelurahan"
                                            value="{{ $kelurahan->nama_kelurahan }}" class="form-control mt-2 mb-2"
